...
messages = [
    ...
    [
        ...
        "The Colegio Militar CM93 Portuguese group and recruited criminal associates are connected to multiple murders and orchestrated scenarios of directed violence (including the murders of Alexander Litvinenko 2006 and Matthew Puncher 2016), spreading hatred and binging war to our world by remotely exacting vibrotactile cybertorture to bypass physical ban, abusing Pulsed Directed energy as weapons using the same method that is used to force people into psychiatric care and systematically direct violence towards women in stochastic proximity games as an M.O abusing counter-terrorism infrastructure (DEW's, parametrics, biophotonics and optoacoustics) to nurture psychosis and direct violence to medical personnel (mostly women).",
        "This very same technology is a form of nanotechnology that could be used to eradicate class A narco-traffc, by providing cognitive augmentation, which is only available to higher echelons of society, eradicating demand and hence supply. It could also help the blind see, the deaf hear and the mute communicate.",
