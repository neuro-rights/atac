...
messages = [
    [
        ...
        "Colegio Militar alumni (largo da luz, Portugal) linked to PEDRO MIGUEL SARAIVA PINHEIRO (former armed forces and telecoms engineer - USA), JOAO FELIPE SARAIVA PINHEIRO (China - connected to @PS), Pedro Miguel de Brito Esteves Grilo @PSP, and the CM93 blue-whale suicide group terrorist cell have been degrading a Ukranian renal patient daily and calling my poor elderly mother a whore all day and night.",
        "They do so everyday as an interactive ritualistic cybertorture spectacle intensified daily at 4:00 am in front of Elected Government Officials and Law Enforcement linked to Gen. Vasco Rocha Vieira (former governor of Macau), Dom Duarte Pio (Duke of Braganca) and the King of the Netherlands.",
        "Others are Pedro Silva (bar A Capela) and 2 idiots nicknamed 'pilas' and 'cajo' who engage in demonic orgy parties where they simulate Van Gogh syndrome and remotely direct violence towards parents and women in stochastic proximity blue-whale suicide games.",
        ...
        "These individuals are linked to Mauro Dias (Frontex - Poland), Felipe Pacheco (germany - professor of languages with the armed forces), Carla Maria Marinho Rodrigues, Joel da Fonte, Hugo Farinha and Jose Ricardo Nazareth Carvalho Figueira @PSP.",
        ...
        "Examples of such hate mongering sub-human pigs are: Bruno Verdier, Luis Nazareth Carvalho Figueira, Rui Ricardo Borges Marques Sabino Reino, Paulo Jorge Varanda (former @UN peacekeeping officer and former president of the Cartaxo municipality for PS), Frederico Ferronha (@CUF hospital), Tiago Alves, Pedro Antao, Ricardo Carrilho, Oscar Ferreira, Tiago Goncalves, Nuno Goncalves, Ricardo Rebordao de Brito, Rui Goncalo Pires Pintado, Augusto Tavares, Tercio Freire, Eduardo Metzner...",
        ...
        "The M.O. of this terrorist cell consists of abusing biophotonics to exact cybertorture and remotely sodomize and rape, simulate van gogh syndrome and induce synthetic states of psychosis simulating tics and facial spasms to simulate schizophrenia and other forms of psychosis in the physical proximity of elderly parents and women (including a ukranian renal patient) in repugnant blue whale suicide games encouraging participation that allawys end up with the demise of the victim and respective family.",
        "Help Close Colegio Militar and place Dom Duarte Pio and his Russian connections (Alice and friends) behind bars. If Colegio Militar alumni cross your paths denounce them or shoot first and ask questions later.",
        "Be extremelly careful with the following idiotic and repugnant terrorist pieces shit who attacked my family to have us be abused, raped and have our teeth broken hidden under the guise of threats of physical violence and psychiatric abuse: Dom Duarte Pio, Artur Pardal, Andre Pardal, Raul Durao, Tiago Goncalves @AEGIS, Nuno Goncalves, Tiago Baleizao @CICLUM Farma, Pedro Miguel de Brito Esteves Grilo @PSP, Ricardo Rebordao de Brito and the infamous coward Jasper Kums @EenvoudAgency.",
        ...
        "Photos of the cowards above: https://github.com/neuro-rights/atac/tree/main/data/assets/img"
    ],
    [
