...
messages = [
    ...
    [
        "I have been forced into a HIC+ 'medical' facility in the Netherlands were patients are systematically remotely abused by portuguese individuals via abuse of directed energy parametric weapon systems to exact cybertorture (a/hrc/43/49) under #opMentalHealth led by individuals with links to the cyberterrorist group anonymous, in the most repugnant, infantile and obnoxious way possible.",
        "by criminal associates of JASPER KUMS @EenvoudAgency like his social circle with connections to law enforcement, residents at Tapada do Mocho in Paco d'Arcos Portugal and Colegio Militar alumni (Largo da Luz, Portugal) who sabotaged the plans of a Ukranian renal patient to get wed to me and my attempt to enlist in the UDL to defend the Ukraine staying behind like cowards inducing psychosis and remotely directing violence to women and medical personnel in stochastic proximity games.",
        "linked to RAUL DURAO, PEDRO MIGUEL SARAIVA PINHEIRO (USA), JOAO FELIPE SARAIVA PINHEIRO (China), RUI RICARDO BORGES MARQUES SABINO REINO, PEDRO MIGUEL DE BRITO ESTEVES GRILO @PSP, PEDRO NUNO DA SILVA ROCHA, TIAGO GONCALVES @Aegis Insurance (with links to the cyber-terrorist group 'Anonymous') and TIAGO BALEIZAO @Ciclum Farma connected to the Portuguese Law Enforcement Blue-Whale Suicide Game Group CM93 along with undesirables recruited @Jardim do Adamastor in the period 2004-2016.",
