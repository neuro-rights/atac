...
class Canary:
    ...
    CANARYSIGN = (
        "riseup.net/ceritificates/riseup-signed-certificate-fingerprints.txt"
    )
    CANARYLINK = (
        "https://riseup.net/about-us/canary/canary-statement-signed.txt"
    )
    ...
    def verify_pubkey(cls):
        ...
        time.sleep(1)
        os.system(
            f"gpg --keyserver {cls.KEYSERVER} --recv-key {cls.FINGERPRINT}"
        )
